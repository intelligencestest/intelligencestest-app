...
exports.CT_DURATION_SECONDS = exports.CT_QUESTIONS = void 0;
exports.scoreResults = scoreResults;
exports.CT_QUESTIONS = [
...
exports.CT_DURATION_SECONDS = 25 * 60;
function scoreResults(answers) {
    let correct = 0;
    answers.forEach((answer, i) => {
        if (answer === exports.CT_QUESTIONS[i].correct)
            correct++;
    });
    const percentage = Math.round((correct / exports.CT_QUESTIONS.length) * 100);
    let interpretation = "";
    let color = "";
    if (percentage >= 90) {
        interpretation = "Exceptional Critical Thinker";
        color = "text-emerald-400";
    }
    else if (percentage >= 75) {
        interpretation = "Strong Critical Thinker";
        color = "text-blue-400";
    }
    else if (percentage >= 60) {
        interpretation = "Developing Critical Thinker";
        color = "text-amber-400";
    }
    else if (percentage >= 45) {
        interpretation = "Basic Critical Thinker";
    ...
    return { correct, total: exports.CT_QUESTIONS.length, percentage, interpretation, color };
}
