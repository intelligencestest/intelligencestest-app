...
exports.extractScoreOnlyEvidence = extractScoreOnlyEvidence;
const taxonomy_1 = require("../taxonomy");
const scales_1 = require("../scales");
function extractScoreOnlyEvidence(input, locale) {
    const assessmentId = input.assessmentId ?? input.id ?? input.name;
    const normalizedScore = (0, scales_1.clampScore)(input.score);
    return [
        {
            ...
            competencyLabel: (0, taxonomy_1.competencyLabel)("assessment-performance", locale),
            kind: "score-only",
