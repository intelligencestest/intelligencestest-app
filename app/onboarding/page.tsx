...
const onboardingCopy: Record<AppLocale, {
  ...
  en: {
    ...
    welcomeTitle: "Set up your agency workspace.",
    welcomeBody:
      "In less than a minute, we will prepare the account to create your first client shortlist, invite candidates, and review executive reports.",
    included: ["14-day trial", "2 client shortlists", "10 candidate invitations"],
    start: "Start setup",
    companyTitle: "Agency",
    companyBody: "These details help tailor the workspace to your recruitment operation.",
    companyName: "Agency name",
    companyPlaceholder: "Acme Recruitment Agency",
    industry: "Industry",
    profileTitle: "Placement volume",
    profileBody: "Use this information to prioritize limits, support, and future recommendations.",
    companySize: "Agency size",
    hiresPerMonth: "Placements per month",
    ...
    createProject: "Create your first client shortlist",
    createProjectHint: "Recommended to see value immediately.",
    dashboard: "Go to dashboard",
    dashboardHint: "Review the workspace before creating a shortlist.",
    back: "Back",
    next: "Continue",
    finish: "Finish setup",
    saving: "Saving...",
