...
export default function ContactForm({ copy, kind, locale }: { copy: PublicCopy; kind: FormKind; locale: "en" | "es" }) {
  ...
  return (
    <form onSubmit={onSubmit} className="rounded-lg border border-[#1E2240] bg-[#0D1020] p-5 sm:p-6">
      ...
      <div className="grid gap-4 sm:grid-cols-2">
        <label className="block">
          ...
          <input
            ...
            className="mt-2 w-full rounded-lg border border-[#1E2240] bg-[#07080F] px-3 py-3 text-sm text-white outline-none transition placeholder:text-slate-600 focus:border-[#1D4ED8] focus:ring-2 focus:ring-[#1D4ED8]/25"
          />
        </label>
        <label className="block">
        ...
        <label className="block">
          ...
          <select
            ...
            className="mt-2 w-full rounded-lg border border-[#1E2240] bg-[#07080F] px-3 py-3 text-sm text-white outline-none transition focus:border-[#1D4ED8] focus:ring-2 focus:ring-[#1D4ED8]/25"
          >
            <option value="">-</option>
      ...
      <label className="mt-4 block">
        ...
        <textarea
          ...
          className="mt-2 w-full resize-y rounded-lg border border-[#1E2240] bg-[#07080F] px-3 py-3 text-sm leading-6 text-white outline-none transition placeholder:text-slate-600 focus:border-[#1D4ED8] focus:ring-2 focus:ring-[#1D4ED8]/25"
        />
      </label>
      ...
      <button
        ...
        className="mt-5 inline-flex w-full items-center justify-center rounded-lg bg-[#1D4ED8] px-5 py-3 text-sm font-semibold text-white transition hover:bg-[#1e40af] focus:outline-none focus:ring-2 focus:ring-[#8CB1FF]/70 disabled:cursor-wait disabled:opacity-70"
      >
