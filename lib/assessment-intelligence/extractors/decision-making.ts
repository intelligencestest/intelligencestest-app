...
const DIMENSIONS: Array<DimensionEvidenceConfig<DMDimension>> = [
  {
    ...
    label: { en: "Analysis", es: "Analisis", fr: "Analyse" },
    positiveImpact: {
      ...
      fr: "Favorise la définition de critères, la vérification des hypothèses et l'utilisation responsable des informations disponibles.",
    },
    riskImpact: {
      ...
      fr: "Peut conduire à négliger des preuves fragiles, des données obsolètes ou des hypothèses non vérifiées avant de décider.",
    },
  },
  {
    id: "Judgment",
    competencyId: "judgment-under-ambiguity",
    label: { en: "Judgment", es: "Juicio", fr: "Jugement" },
    positiveImpact: {
      ...
      fr: "Favorise un jugement équilibré lorsque des arbitrages, de l'incertitude ou des désaccords sont présents.",
    },
    riskImpact: {
      ...
      fr: "Peut conduire à trop s'appuyer sur l'autorité, l'intuition ou le consensus lorsque les preuves sont ambiguës.",
    },
  },
  {
    id: "Risk Assessment",
    competencyId: "risk-evaluation",
    label: { en: "Risk assessment", es: "Evaluacion de riesgos", fr: "Évaluation des risques" },
    positiveImpact: {
      ...
      fr: "Favorise la prise en compte de la probabilité, de l'impact, des mesures d'atténuation et de la valeur attendue avant d'agir.",
    },
    riskImpact: {
      ...
      fr: "Peut sous-estimer les conséquences, les besoins de suivi ou les exigences d'atténuation.",
    },
  },
  {
    id: "Speed",
    competencyId: "decision-speed-calibration",
    label: { en: "Speed", es: "Velocidad", fr: "Rapidité" },
    positiveImpact: {
      ...
      fr: "Favorise l'adaptation du rythme de décision à l'urgence, aux enjeux et à la réversibilité.",
    },
    riskImpact: {
      ...
      fr: "Peut conduire à précipiter des décisions à fort enjeu ou à trop analyser des choix réversibles.",
    },
  },
];
...
export function extractDecisionMakingEvidence(input: AssessmentResultInput, locale: IntelligenceLocale) {
  return buildStructuredChoiceEvidence({
    ...
    kind: "judgment",
    assessmentLabel: { en: "decision-making judgment", es: "juicio para toma de decisiones", fr: "jugement dans la prise de décision" },
    ...
    limitation: {
      ...
      fr: "Decision Making mesure le jugement structuré dans des scénarios d'évaluation ; il ne mesure ni l'expertise métier, ni le niveau d'autorité, ni l'ensemble du contexte opérationnel.",
    },
  });
}
