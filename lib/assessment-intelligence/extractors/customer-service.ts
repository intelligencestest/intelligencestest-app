...
const DIMENSIONS: Array<DimensionEvidenceConfig<CServDimension>> = [
  ...
  },
  {
    ...
    label: { en: "Problem resolution", es: "Resolucion de incidencias" },
    positiveImpact: {
  ...
  },
  {
    ...
    label: { en: "Patience", es: "Paciencia" },
    positiveImpact: {
...
export function extractCustomerServiceEvidence(input: AssessmentResultInput, locale: IntelligenceLocale) {
  return buildStructuredChoiceEvidence({
    ...
    kind: "service",
    assessmentLabel: { en: "customer service judgment", es: "criterio de servicio al cliente" },
